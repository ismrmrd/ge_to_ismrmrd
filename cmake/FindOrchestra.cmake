...
set (ORCHESTRA_INCLUDE_DIRS $ENV{SDKTOP}/include/recon/3p/mac)
...
find_path(ORCHESTRA_HDF5_INCLUDE_DIR hdf5.h
    ...
    PATH_SUFFIXES mac/hdf5-1.8.12/include Linux/hdf5-1.8.12_dev_linux64/include
    NO_DEFAULT_PATH)
...
foreach(lib h5tools hdf5_cpp hdf5)
    find_library(ORCHESTRA_HDF5_${lib}_LIBRARY ${lib}
        PATHS ${ORCHESTRA_TOPDIR}/3p
        PATH_SUFFIXES mac/hdf5-1.8.12/lib Linux/hdf5-1.8.12_dev_linux64/lib
        NO_DEFAULT_PATH)
...
foreach(lib dcmdata dcmnet oflog ofstd)
    find_library(ORCHESTRA_DCMTK_${lib}_LIBRARY ${lib}
        PATHS ${ORCHESTRA_TOPDIR}/3p
        PATH_SUFFIXES mac/dcmtk-3.6.1_20140617/lib Linux/dcmtk-3.6.0_dev_linux64/lib
        NO_DEFAULT_PATH)
...
foreach(lib fftw3f fftw3)
    find_library(ORCHESTRA_FFTW_${lib}_LIBRARY ${lib}
        PATHS ${ORCHESTRA_TOPDIR}/3p
        PATH_SUFFIXES mac/fftw-3.2.2/lib Linux/fftw-3.2.2_dev_linux64/lib
        NO_DEFAULT_PATH)
...
find_path(ORCHESTRA_BOOST_INCLUDE_DIR boost/version.hpp
    PATHS ${ORCHESTRA_TOPDIR}/3p
    PATH_SUFFIXES mac/boost_1_63_0/include Linux/boost_1_55_0_dev_linux64/include
    NO_DEFAULT_PATH)
...
foreach(lib date_time program_options filesystem regex serialization wserialization thread system)
    find_library(ORCHESTRA_BOOST_${lib}_LIBRARY "boost_${lib}"
        PATHS ${ORCHESTRA_TOPDIR}/3p
        PATH_SUFFIXES mac/boost_1_63_0/lib Linux/boost_1_55_0_dev_linux64/lib
        NO_DEFAULT_PATH)
...
foreach(lib lapack blas f2c)
    find_library(ORCHESTRA_LAPACK_${lib}_LIBRARY ${lib}
        PATHS ${ORCHESTRA_TOPDIR}/3p
        PATH_SUFFIXES mac/clapack-3.2.1/lib Linux/clapack-3.2.1_dev_linux64/lib
        NO_DEFAULT_PATH)
...
find_path(ORCHESTRA_BLITZ_INCLUDE_DIR blitz/blitz.h
    PATHS ${ORCHESTRA_TOPDIR}/3p
    PATH_SUFFIXES mac/blitz-0.10/include Linux/blitz-0.10_dev_linux64/include)
...
find_library(ORCHESTRA_BLITZ_LIBRARY blitz
    PATHS ${ORCHESTRA_TOPDIR}/3p
    PATH_SUFFIXES mac/blitz-0.10/lib Linux/blitz-0.10_dev_linux64/lib
    NO_DEFAULT_PATH)
